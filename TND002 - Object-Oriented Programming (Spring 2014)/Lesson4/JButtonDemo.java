...
public class JButtonDemo extends JFrame implements ActionListener{
    ...
    private JButton buttRed, buttGreen, buttBlue;
    ...
    public JButtonDemo(){
        ...
        buttRed = new JButton("Red");
        buttGreen = new JButton("Green");
        buttBlue = new JButton("Blue");
        ...
        panelEast.add(buttRed);
        panelEast.add(buttGreen);
        panelEast.add(buttBlue);
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == buttRed){
            labelDemo.setForeground(Color.RED);
        }
        else if(e.getSource() == buttGreen){
            labelDemo.setForeground(Color.GREEN);
        }
        else{
            labelDemo.setForeground(Color.BLUE);
        }
            
    }
      public static void main(String[] args){
            JButtonDemo lek = new JButtonDemo();
        }
