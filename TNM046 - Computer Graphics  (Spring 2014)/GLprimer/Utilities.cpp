...
//Multiplicera ihop två matriser!
void mat4mult(float M1[], float M2[], float Mout[]) {

    float Mtemp[16];

    //Compute the elements of Mout, stupid code...
...
//Create an identitymatrix. Overwrite the input argument.
...
void mat4print(float M []){
    ...
    //Print out the Composite transformation matrix
    printf ("Matrix:\n");
